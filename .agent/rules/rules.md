...
7. Efficiency Principle
   ...
   Debugging Protocol
   Simple bugs:
8. Try Gemini for quick analysis
9. If solution is clear → Apply it
10. If uncertain → Escalate to Claude
11. Always test the fix
    Complex bugs:
12. Use Claude for deep reasoning
13. Trace execution flow
14. Identify all edge cases
15. Implement robust fix
16. Add regression tests
    When stuck:
17. Get Gemini's fresh perspective
18. Claude analyzes and synthesizes
19. Gemini generates test cases
20. Claude validates and refines
    Quality Gates
...
Use the latest and proper syntax as codebase is Next.JS 16.
