        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.section}>
            ...
            <Text style={styles.text}>
              ...
              <strong>scheduled</strong> with Dr. {doctorName}.
            </Text>
            ...
            <Button
              style={styles.button}
              href={
                process.env.NEXT_PUBLIC_APP_URL || "https://hygieia.vercel.app/"
              }
            >
...
export const CancelledAppointmentEmail: React.FC<AppointmentEmailProps> = ({
  ...
  return (
    <Html>
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Heading style={{ ...styles.header, color: "#b91c1c" }}>
          ...
          <Section style={styles.section}>
            ...
            <Text style={styles.text}>
              ...
              {doctorName} has been <strong>cancelled</strong>.
            </Text>
            ...
            <Text style={styles.text}>
              We apologize for any inconvenience this may cause. Please click
              the button below to reschedule your appointment at a more
              convenient time.
            </Text>
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.section}>
            <Text style={styles.text}>Dear {patientName},</Text>
            <Text style={styles.text}>
              Dr. {referringDoctorName} has referred you to a specialist for
            ...
            <Section style={styles.detailsSection}>
              ...
              <Text style={styles.detailsText}>
                • <strong>Referral Number:</strong> {referralNumber}
              </Text>
              <Text style={styles.detailsText}>
                • <strong>Referred to:</strong> Dr. {referredDoctorName}
              </Text>
              <Text style={styles.detailsText}>
                • <strong>Department:</strong> {referredDepartment}
              </Text>
              <Text style={styles.detailsText}>
              ...
              <Text style={styles.detailsText}>
                • <strong>Reason:</strong> {reasonForReferral}
              </Text>
            </Section>
            ...
            <Text style={styles.text}>
              <strong>Important:</strong> Please bring this referral number (
              {referralNumber}) when you visit the specialist, along with your
            ...
            <Text style={styles.text}>
              If you have any questions about this referral, please contact Dr.{" "}
              {referringDoctorName}&apos;s office.
            </Text>
    ...
    return workSchedule
      .map((schedule) => {
        ...
        const endTimeDisplay =
          schedule.close_time === "00:00" ? "12:00 AM (Next Day)" : endTime12;
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.section}>
            ...
            <Text style={styles.text}>
              Welcome to the HYGIEIA Integrated Hospital Management System! Your
              account has been successfully created by{" "}
            ...
            <Text style={styles.text}>
              <strong>Important Security Notice:</strong> For your security,
              please change your password after your first login. You can do
              this by accessing your profile settings.
            </Text>
            ...
            <Text style={styles.text}>
              1. Click the button above to access the system
              <br />
            ...
            <Text style={styles.text}>
              ...
              please don&apos;t hesitate to contact the system administrator or
              IT support team.
            </Text>
...
export const StaffWelcomeEmail: React.FC<StaffWelcomeEmailProps> = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Welcome to HYGIEIA IHMS - Your staff account has been created
      </Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Heading style={{ ...styles.header, color: "#059669" }}>
            Welcome to HYGIEIA IHMS
          </Heading>
          <Section style={styles.section}>
            <Text style={styles.text}>Dear {staffName},</Text>
            <Text style={styles.text}>
              Welcome to the HYGIEIA Integrated Hospital Management System! Your
              staff account has been successfully created by{" "}
              <strong>{adminName}</strong>.
            </Text>
            ...
            <Text style={styles.text}>
              <strong>Login Details:</strong> Please ensure your email account
              remains secure, as password changes must be requested through your
              administrator.
            </Text>
            ...
            <Text style={styles.text}>
              ...
              2. Log in using your credentials
              <br />
              3. Familiarize yourself with the dashboard and your role-specific
              features
            </Text>

            <Text style={styles.text}>
              As a <strong>{formatRole(role)}</strong>, you will have access to
              the features and modules relevant to your role within the hospital
              management system. Please take some time to explore your dashboard
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.section}>
            <Text style={styles.text}>Dear {patientName},</Text>
            <Text style={styles.text}>
              We hope you had a positive experience during your recent visit.
              Your appointment with Dr. {doctorName} has been marked as{" "}
            ...
            <Text style={styles.text}>
              ...
              <br />
              Please proceed to payment/billing to complete your visit. You can
              settle your bill at the front desk or through our online payment
              portal.
            </Text>
            ...
            <Text style={styles.text}>
              If you have any questions about your visit or billing, please
              don&apos;t hesitate to contact our billing department or front
              desk staff.
            </Text>

            <Text style={styles.text}>
              Thank you for choosing our medical services. We look forward to
              serving you again.
            </Text>
