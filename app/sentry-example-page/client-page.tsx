      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://kyle-soliman-project-hygieia.sentry.io/issues/?project=4510622850416720"
          >
            Issues Page
          </a>
        ...
        <button
          ...
          onClick={() => {
            Sentry.captureException(
              new Error("TEST: PII Scrubbing (Should not see email/IP)"),
              {
                user: {
            ...
            alert(
              "Sent error with fake PII. Check Sentry to verify email/IP were removed."
            );
          }}
          disabled={!isConnected}
        >
        ...
        <button
          ...
          onClick={() => {
            Sentry.captureMessage(
              "TEST: PHI Redaction - Patient Diagnosis: Acute Hypertension. MRN: 998877"
            );
            alert(
              "Sent message with PHI keywords. Check Sentry to verify keywords were redacted."
            );
          }}
          disabled={!isConnected}
        >
